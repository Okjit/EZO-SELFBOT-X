...
def startprint():
    ...
    print(f'''{Fore.RESET}
                       ...
                       {Fore.CYAN}ezo v{SELFBOT.__version__} | {Fore.GREEN}Logged in as: {ezo.user.name}#{ezo.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{ezo.user.id}   
                       {Fore.CYAN}Nitro Sniper | {Fore.GREEN}{nitro}
                       {Fore.CYAN}Cached Users: {Fore.GREEN}{len(ezo.users)}
                       {Fore.CYAN}Guilds: {Fore.GREEN}{len(ezo.guilds)}
                       {Fore.CYAN}Prefix: {Fore.GREEN}{ezo.command_prefix}
    ''' + Fore.RESET)
